...
--
-- Host: localhost
-- Generation Time: 11-Nov-2019 às 23:36
...
INSERT INTO `status` (`cod_status`, `descricao_status`) VALUES
(1, 'Aprovado'),
(2, 'Pendente'),
(3, 'Negado');
...
ALTER TABLE `pedido`
  ...
  ADD CONSTRAINT `fk_pedido_status` FOREIGN KEY (`cod_status`) REFERENCES `status` (`cod_status`);
