...
--
-- Host: localhost
-- Generation Time: 12-Nov-2019 às 00:55
...
INSERT INTO `ddd` (`cod_ddd`, `descricao`) VALUES
(11, 'São Paulo'),
...
INSERT INTO `telefone` (`cod_telefone`, `cpf`, `numero`, `tipo`, `cod_ddd`) VALUES
(2, 47480400845, 950293448, '{Celular}', 11);
...
--
ALTER TABLE `telefone`
  MODIFY `cod_telefone` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
